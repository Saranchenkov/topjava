    ...
    <div class="container">
        <div class="shadow">
            ...
            <div class="view-box">
                ...
                <a class="btn btn-info" onclick="add('Добавление еды')">
                    ...
                    <table class="table table-striped display" id="datatable">
                        ...
                        <c:forEach items="${meals}" var="meal">
                            ...
                            <tr id="${meal.id}" class="${meal.exceed ? 'exceeded' : 'normal'}">
                                ...
                                <td>${meal.calories}</td>
                                <td>
                                    <a class="btn btn-xs btn-primary" onclick="updateRow('${meal.id}')">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="detailsForm" class="form-horizontal" action="/meals" method="post">
