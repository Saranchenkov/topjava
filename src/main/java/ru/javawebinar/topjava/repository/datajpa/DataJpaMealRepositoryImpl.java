...
public class DataJpaMealRepositoryImpl implements MealRepository {
    ...
    public List<Meal> getAll(int userId) {
        return mealRepository.findAllByUser_IdEqualsOrderByDateTimeDesc(userId);
    }

    @Override
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return mealRepository.findAllByUser_IdEqualsAndDateTimeBetweenOrderByDateTimeDesc(userId, startDate, endDate);
    }
}
