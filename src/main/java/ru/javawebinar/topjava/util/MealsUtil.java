...
public class MealsUtil {
    ...
    public static List<MealWithExceed> getWithExceedByDateTime(Collection<Meal> meals, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime, int caloriesPerDay){
